...
public:
	...
	xn::DepthGenerator *GetDepthGenerator() { return m_DepthGenerator; };
	xn::ImageGenerator *GetImageGenerator() { return m_ImageGenerator; };
    ...
    /// @}
	KVertex getHeadPosition(XnUserID nUserID);
